...
<head>
  ...
  <!-- DATATABLE JS-->
    ...
    <script src="https://cdn.datatables.net/v/bs5/jq-3.6.0/dt-1.13.1/b-2.3.2/b-colvis-2.3.2/datatables.min.js"></script>  <!-- SHOW/HIDE COLUMN -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jszip/3.1.3/jszip.min.js"></script> <!-- EXCEL EXPORT -->
