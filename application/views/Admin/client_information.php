        ...
        <div class="card-body">
            ...
            <div id="IndentifyingInformation" class="tabcontent">
                <div class="mb-3 mt-2">
                    ...
                    <button class="btn btn-replace hvr-float-shadow" data-bs-toggle="modal" data-bs-target="#replaceModal" <?php echo $styleDisplay; ?> ><i class="fa-solid fa-retweet"></i> Replace</button>
                    <a href="<?php echo base_url().'client/delete/'.$client_id=$row->client_id; ?>" class="btn btn-delete hvr-float-shadow" onclick="return confirm('Are you sure you want to delete?')"><i class="fa-solid fa-trash fa-sm"></i> Delete</a>
                </div>

                <form method="POST" action="<?php echo base_url().'client/update_client_identifying_information'; ?>" id="identifying_information_form" autocomplete="off">
                    <div class="row">
...
<script>
// Initialize date picker with auto-disable based on 'readonly' state
...
}).datepicker("disable");  // Initially disable the date picker
