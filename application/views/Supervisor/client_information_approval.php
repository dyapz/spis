    ...
    <div class="card card-shadow my-4" style="width: 76rem;">
        ...
        <div class="card-body">
            ...
            <div id="IndentifyingInformation" class="tabcontent">
                <div class="mb-3 mt-2">
                    <a href="<?php echo base_url().'supervisor/client/approval'; ?>" class="btn btn-back hvr-float-shadow"><i class="fa-solid fa-caret-left"></i> Back</a>
                </div>
            ...
            <div id="Recommendation" class="tabcontent">
                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        ...
                        <form action="<?php echo base_url().'supervisor/client/conform' ?>" method="post" id="assignForm">
                            <input type="hidden" name="client_id" value="<?php echo $client_id; ?>" readonly>
                            <button type="submit" class="btn btn-custom hvr-float-shadow" style="width: 300px" onclick="return confirm('Are you sure you want to approve?')"><i class="fa-solid fa-thumbs-up"></i> Approve</button>
                        </form>
