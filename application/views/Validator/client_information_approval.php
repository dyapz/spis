...
<div class="container-fluid d-flex justify-content-center">
    <div class="card card-shadow my-4" style="width: 76rem;">
        <div class="card-header">For Approval</div>
        <div class="card-body">
            ...
            <div id="IndentifyingInformation" class="tabcontent">
                <div class="mb-3 mt-2">
                    <a href="<?php echo base_url().'validator/client/approval'; ?>" class="btn btn-back hvr-float-shadow"><i class="fa-solid fa-caret-left"></i> Back</a>
                </div>
            ...
            <div id="Recommendation" class="tabcontent">
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <textarea class="form-control form-custom textarea-custom" name="cr_remarks" placeholder="" rows="20" readonly><?php echo $cr_remarks; ?></textarea>
                    ...
                    <div class="col-md-5">
                        ...
                        <?php if($cr_conformed_by == 0) {

                            echo '<p class="fw-bold text-danger">Waiting for Approval</a>';
                        }else{
