<?php 
    ...
    foreach($client_information as $row) { 
        ...
        // assessment
        $cea_sixty_yrs_old = $row->cea_sixty_yrs_old;
        $cea_pension = $row->cea_pension;
        $cea_pension_sss = $row->cea_pension_sss;
        $cea_pension_gsis = $row->cea_pension_gsis;
        $cea_pension_pvao = $row->cea_pension_pvao;
        $cea_regular_income = $row->cea_regular_income;
        $cea_regular_income_specify = $row->cea_regular_income_specify;
        $cea_existing_illness = $row->cea_existing_illness;
        $cea_existing_illness_specify = $row->cea_existing_illness_specify;
        $cea_disability = $row->cea_disability;
        $cea_disability_deaf = $row->cea_disability_deaf;
        $cea_disability_intellectual = $row->cea_disability_intellectual;
        $cea_disability_learning = $row->cea_disability_learning;
        $cea_disability_mental = $row->cea_disability_mental;
        $cea_disability_psychosocial = $row->cea_disability_psychosocial;
        $cea_disability_cancer = $row->cea_disability_cancer;
        $cea_disability_visual = $row->cea_disability_visual;
        $cea_disability_speech_and_language = $row->cea_disability_speech_and_language;
        $cea_disability_rare_disease = $row->cea_disability_rare_disease;
        $cea_daily_living = $row->cea_daily_living;
        $cea_daily_living_bathing = $row->cea_daily_living_bathing;
        $cea_daily_living_dressing = $row->cea_daily_living_dressing;
        $cea_daily_living_grooming = $row->cea_daily_living_grooming;
        $cea_daily_living_eating = $row->cea_daily_living_eating;
        $cea_daily_living_toileting = $row->cea_daily_living_toileting;
        $cea_daily_living_transferring = $row->cea_daily_living_transferring;
        $cea_daily_living_cooking = $row->cea_daily_living_cooking;
        $cea_daily_living_cleaning = $row->cea_daily_living_cleaning;
        $cea_daily_living_managing_finance = $row->cea_daily_living_managing_finance;
        $cea_daily_living_grocery_shopping = $row->cea_daily_living_grocery_shopping;
        $cea_daily_living_managing_medications = $row->cea_daily_living_managing_medications;
        $user_id = $this->session->user_id; 

        //recommedation
        $cr_remarks = $row->cr_remarks;
        $user_fname = $row->user_fname;
        $user_mname = $row->user_mname;
        $user_lname = $row->user_lname;
        $user_ename = $row->user_ename;
        $user_designation = $row->user_designation;
        $cr_validated_date = $row->cr_validated_date;

        $cr_conformed_by = $row->cr_conformed_by;
        $conformed_fname = $row->conformed_fname;
        $conformed_mname = $row->conformed_mname;
        $conformed_lname = $row->conformed_lname;
        $conformed_ename = $row->conformed_ename;
        $conformed_designation = $row->conformed_designation;
        $cr_conformed_date = $row->cr_conformed_date;
...
<div class="container-fluid d-flex justify-content-center">
    <div class="card card-shadow my-4" style="width: 76rem;">
        ...
        <div class="card-body">
            ...
            <div id="IndentifyingInformation" class="tabcontent">
                <div class="mb-3 mt-2">
                    <a href="<?php echo base_url().'validator/client/list'; ?>" class="btn btn-back hvr-float-shadow"><i class="fa-solid fa-caret-left"></i> Back</a>
                </div>

                    <div class="row">
                        <label class="label mb-3 fw-bold">NAME:</label><br>
                        <div class="form-group col-md-3">
                            <input type="text" class="form-control form-custom recommendation_edit" pattern="[A-Za-z\s]+" title="Only letters and spaces are allowed" name="client_lname" value="<?php echo set_value('client_lname', isset($client_lname) ? $client_lname : '');?>"  placeholder="" required readonly>
                            <label class="form-label fw-bold">LAST NAME <span class="text-danger">*</span></label>
                        </div>

                        <div class="form-group col-md-3">
                            <input type="text" class="form-control form-custom recommendation_edit" pattern="[A-Za-z\s]+" title="Only letters and spaces are allowed" name="client_fname" value="<?php echo set_value('client_fname', isset($client_fname) ? $client_fname : ''); ?>" placeholder="" required readonly>
                            <label class="form-label fw-bold">FIRST NAME <span class="text-danger">*</span></label>
                        </div>

                        <div class="form-group col-md-3">
                            <input type="text" class="form-control form-custom recommendation_edit" pattern="[A-Za-z\s]+" title="Only letters and spaces are allowed" name="client_mname" value="<?php echo set_value('client_mname', isset($client_mname) ? $client_mname : '');?>" placeholder="" readonly>
                            <label class="form-label fw-bold">MIDDLE NAME</label>
                        </div>

                        <div class="form-group col-md-3">
                            <input type="text" class="form-control form-custom recommendation_edit" pattern="[A-Za-z\s]+" title="Only letters and spaces are allowed" name="client_ename" value="<?php echo set_value('client_ename', isset($client_ename) ? $client_ename : '');?>" placeholder="" readonly>
                            <label class="form-label fw-bold">EXT. NAME</label>
                        </div>

                        <div class="form-group col-md-4">
                            <input type="text" class="form-control form-custom recommendation_edit" pattern="[A-Za-z0-9\s]+" title="Only letters, numbers, and spaces are allowed" name="osca_id" value="<?php echo set_value('osca_id', isset($osca_id) ? $osca_id : '');?>" placeholder="" required readonly>
                            <label class="form-label fw-bold">OSCA ID No. <span class="text-danger">*</span></label>
                        </div>

                        <div class="form-group col-md-4">
                            <input type="text" class="form-control form-custom recommendation_edit" pattern="[A-Za-z0-9\s]+" title="Only letters, numbers, and spaces are allowed" name="philsys_id" value="<?php echo set_value('philsys_id', isset($philsys_id) ? $philsys_id : '');?>" placeholder="" readonly>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="radio-btn-group">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input recommendation_edit" type="radio" name="pantawid_y_n" id="4psyes" value="1" <?php echo (isset($pantawid_y_n) && $pantawid_y_n == 1) ? 'checked' : ''; ?> required disabled>
                                    <label class="form-check-label" for="4psyes">Yes</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input recommendation_edit" type="radio" name="pantawid_y_n" id="4psno" value="2" <?php echo (isset($pantawid_y_n) && $pantawid_y_n == 2) ? 'checked' : ''; ?> disabled>
                        ...
                        <div class="form-group col-md-4">
                            <input type="text" class="form-control form-custom recommendation_edit" pattern="[A-Za-z\s]+" title="Only letters and spaces are allowed"   name="mothers_maiden_lname" value="<?php echo set_value('mothers_maiden_lname', isset($mothers_maiden_lname) ? $mothers_maiden_lname : '');?>" placeholder="" required readonly>
                            <label class="form-label fw-bold">LAST NAME <span class="text-danger">*</span></label>
                        </div>

                        <div class="form-group col-md-4">
                            <input type="text" class="form-control form-custom recommendation_edit" pattern="[A-Za-z\s]+" title="Only letters and spaces are allowed"   name="mothers_maiden_fname" value="<?php echo set_value('mothers_maiden_fname', isset($mothers_maiden_fname) ? $mothers_maiden_fname : '');?>" placeholder="" required readonly>
                            <label class="form-label fw-bold">FIRST NAME <span class="text-danger">*</span></label>
                        </div>

                        <div class="form-group col-md-4">
                            <input type="text" class="form-control form-custom recommendation_edit" pattern="[A-Za-z\s]+" title="Only letters and spaces are allowed"   name="mothers_maiden_mname" value="<?php echo set_value('mothers_maiden_mname', isset($mothers_maiden_mname) ? $mothers_maiden_mname : '');?>" placeholder="" readonly>
                            <label class="form-label fw-bold">MIDDLE NAME</label>
                        </div>

                        <label class="label mb-3 fw-bold">PERMANENT ADDRESS:</label><br>
                        <div class="form-group col-md-4">
                            <select name="perm_region" id="perm_region" class="form-select <?php echo (isset($perm_region) && $perm_region == $perm_region) ? 'has-value' : ''; ?> recommendation_edit" required disabled>
                        ...
                        <div class="form-group col-md-4">
                            <select class="form-select <?php echo (isset($perm_prov) && $perm_prov == $perm_prov) ? 'has-value' : ''; ?> recommendation_edit" name="perm_prov" id="perm_prov" required disabled>
                        ...
                        <div class="form-group col-md-4">
                            <select class="form-select <?php echo (isset($perm_muni) && $perm_muni == $perm_muni) ? 'has-value' : ''; ?> recommendation_edit" name="perm_muni" id="perm_muni" required disabled>
                        ...
                        <div class="form-group col-md-4">
                            <select class="form-select <?php echo (isset($perm_brgy) && $perm_brgy == $perm_brgy) ? 'has-value' : ''; ?> recommendation_edit" name="perm_brgy" id="perm_brgy" required disabled>
                        ...
                        <div class="form-group col-md-4">
                            <input type="text" class="form-control form-custom recommendation_edit" pattern="[A-Za-z0-9\s]+" title="Only letters, numbers, and spaces are allowed" name="perm_sitio" id="perm_sitio" value="<?php echo set_value('perm_sitio', isset($perm_sitio) ? $perm_sitio : '');?>" placeholder="" required readonly>
                            <label class="form-label fw-bold">HOUSE NO./ PUROK <span class="text-danger">*</span></label>
                        </div>
                        
                        <div class="form-group col-md-4">
                            <input type="text" class="form-control form-custom recommendation_edit" pattern="[A-Za-z0-9\s]+" title="Only letters, numbers, and spaces are allowed" name="perm_street" id="perm_street" value="<?php echo set_value('perm_street', isset($perm_street) ? $perm_street : '');?>" placeholder="" required readonly>
                            <label class="form-label fw-bold">STREET <span class="text-danger">*</span></label>
                        </div>
                    </div>

                    <div class="form-check mb-2">
                        <input class="form-check-input recommendation_edit" type="checkbox" value="1" id="copyResult" name="same_address" <?php echo (isset($same_address) && $same_address == 1) ? 'checked' : ''; ?> disabled>
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="form-group col-md-4">
                            <select name="pre_region" id="pre_region" class="form-select <?php echo (isset($pre_region) && $pre_region == $pre_region) ? 'has-value' : ''; ?> recommendation_edit" required disabled>
                                <option value="" disabled selected></option>
                                <?php foreach($region as $row): ?>
                                    <option value="<?php echo $row->region_id; ?>" 
                        ...
                        <div class="form-group col-md-4">
                            <select class="form-select <?php echo (isset($pre_prov) && $pre_prov == $pre_prov) ? 'has-value' : ''; ?> recommendation_edit" name="pre_prov" id="pre_prov" required disabled>
                        ...
                        <div class="form-group col-md-4">
                            <select class="form-select <?php echo (isset($pre_muni) && $pre_muni == $pre_muni) ? 'has-value' : ''; ?> recommendation_edit" name="pre_muni" id="pre_muni" required disabled>
                        ...
                        <div class="form-group col-md-4">
                            <select class="form-select <?php echo (isset($pre_brgy) && $pre_brgy == $pre_brgy) ? 'has-value' : ''; ?> recommendation_edit" name="pre_brgy" id="pre_brgy" required disabled>
                        ...
                        <div class="form-group col-md-4">
                            <input type="text" class="form-control form-custom recommendation_edit" pattern="[A-Za-z0-9\s]+" title="Only letters, numbers, and spaces are allowed" name="pre_sitio" id="pre_sitio" value="<?php echo set_value('pre_sitio', isset($pre_sitio) ? $pre_sitio : '');?>" placeholder="" required readonly>
                            <label class="form-label fw-bold">HOUSE NO./ PUROK <span class="text-danger">*</span></label>
                        </div>

                            <div class="form-group col-md-4">
                                <input type="text" class="form-control form-custom recommendation_edit" pattern="[A-Za-z0-9\s]+" title="Only letters, numbers, and spaces are allowed" name="pre_street" id="pre_street" value="<?php echo set_value('pre_street', isset($pre_street) ? $pre_street : '');?>" placeholder="" required readonly>
                                <label class="form-label fw-bold">STREET <span class="text-danger">*</span></label>
                            </div>
                        </div>

                        <div class="form-group col-md-2">
                            <input type="text" class="form-control form-custom date-picker recommendation_edit" name="birthdate" id="bday" value="<?php echo set_value('birthdate', isset($birthdate) ? $birthdate : '');?>" onchange="submitBday()" placeholder="" required readonly>
                        ...
                        <div class="form-group col-md-2">
                            <input type="text" class="form-control form-custom recommendation_edit" pattern="[A-Za-z\s]+" title="Only letters and spaces are allowed" name="birth_place" value="<?php echo set_value('birth_place', isset($birth_place) ? $birth_place : '');?>" placeholder="" required readonly>
                        ...
                        <div class="form-group col-md-3">
                            <select class="form-select <?php echo (isset($sex) && $sex == $sex) ? 'has-value' : ''; ?> recommendation_edit" name="sex" required disabled>
                                <option value="" disabled selected></option>
                        ...
                        <div class="form-group col-md-2">
                            <select class="form-select <?php echo (isset($civil_status) && $civil_status == $civil_status) ? 'has-value' : ''; ?> recommendation_edit" name="civil_status" id="civil_status" required disabled>
                                <option value="" disabled selected></option>
                        ...
                        <div class="form-group col-md-2" id="cs_others_group" style="display: none;">
                            <input type="text" id="cs_others" class="form-control form-custom recommendation_edit" pattern="[A-Za-z\s]+" title="Only letters and spaces are allowed" name="cs_others" value="<?php echo set_value('cs_others', isset($cs_others) ? $cs_others : '');?>" placeholder="" readonly>
                        ...
                        <div class="form-group col-md-3 d-flex justify-content-start">
                            <select id="living_arrangement" name="living_arrangement" class="form-select <?php echo (isset($living_arrangement) && $living_arrangement == $living_arrangement) ? 'has-value' : ''; ?> recommendation_edit" required disabled>
                                <option value="" disabled selected></option>
                        ...
                        <div class="form-group col-md-3" id="living_arrangement_others_group" style="display: none;">
                            <input type="text" id="living_arrangement_others" class="form-control form-custom recommendation_edit" pattern="[A-Za-z\s]+" title="Only letters and spaces are allowed" name="living_arrangement_others" value="<?php echo set_value('living_arrangement_others', isset($living_arrangement_others) ? $living_arrangement_others : '');?>" placeholder="" readonly>
                            <label class="form-label fw-bold">SPECIFY <span class="text-danger">*</span></label>
                        </div>
                        ...
                        <div class="form-group col-md-3">
                            <select id="sector" class="form-select <?php echo (isset($sector) && $sector == $sector) ? 'has-value' : ''; ?> recommendation_edit" name="sector" required disabled>
                                <option value="" disabled selected></option>
                        ...
                        <div id="ip_specify_group" style="display: none;">
                                <input type="text" id="ip_specify" class="form-control form-custom recommendation_edit" name="ip_specify" value="<?php echo set_value('ip_specify', isset($ip_specify) ? $ip_specify : '');?>" placeholder="" readonly>
                                <label class="form-label fw-bold">SPECIFY <span class="text-danger">*</span></label>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        <div class="radio-btn-group">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="cea_sixty_yrs_old" id="cea_sixty_yrs_old_yes" value="1" <?php if ($cea_sixty_yrs_old == 1){ echo 'checked'; } ?> onclick="return false;">
                                <label class="form-check-label" for="cea_sixty_yrs_old_yes">Yes</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="cea_sixty_yrs_old" id="cea_sixty_yrs_old_no" value="2" <?php if ($cea_sixty_yrs_old == 2){ echo 'checked'; } ?> onclick="return false;">
                    ...
                    <div class="form-group col-md-12">
                        <div class="radio-btn-group">
                            ...
                            <div class="form-check form-check-inline">
                            <input type="radio" name="cea_pension" id="cea_pension_yes" value="1" class="form-check-input" <?php if ($cea_pension == 1){ echo 'checked'; } ?> onclick="return false;" required>
                            <label for="cea_pension_yes">Yes</label>
                        </div>
                            <div class="form-check form-check-inline">
                            <input type="radio" name="cea_pension" id="cea_pension_no" value="2" class="form-check-input" <?php if ($cea_pension == 2){ echo 'checked'; } ?> onclick="return false;">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <div class="form-check form-switch form-check-inline">
                            <input class="form-check-input" type="checkbox" name="cea_pension_sss" id="cea_pension_sss" value="1" <?php if ($cea_pension_sss == 1){ echo 'checked'; }else{ echo 'disabled'; } ?> onclick="return false;">
                            <label class="form-check-label" for="cea_pension_sss" >SSS</label>
                        </div>
                        <div class="form-check form-switch form-check-inline">
                            <input class="form-check-input" type="checkbox" name="cea_pension_gsis" id="cea_pension_gsis" value="1" <?php if ($cea_pension_gsis == 1){ echo 'checked'; }else{ echo 'disabled'; } ?> onclick="return false;">
                            <label class="form-check-label" for="cea_pension_gsis">GSIS</label>
                        </div>
                        <div class="form-check form-switch form-check-inline">
                            <input class="form-check-input" type="checkbox" name="cea_pension_pvao" id="cea_pension_pvao" value="1" <?php if ($cea_pension_pvao == 1) { echo 'checked'; }else{ echo 'disabled'; } ?> onclick="return false;">
                    ...
                    <div class="form-group col-md-12">
                        <div class="radio-btn-group">
                            ...
                            <div class="form-check form-check-inline">
                                <input type="radio" name="cea_regular_income" id="cea_regular_income_yes" value="1" class="form-check-input" <?php if ($cea_regular_income == 1) { echo 'checked'; } ?> onclick="return false;" required>
                                <label for="cea_regular_income_yes">Yes</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input type="radio" name="cea_regular_income" id="cea_regular_income_no" value="2" class="form-check-input" <?php if ($cea_regular_income == 2) { echo 'checked'; } ?> onclick="return false;">
                    ...
                    <div class="form-group col-md-12">
                        <div class="form-group col-md-3">
                            <input type="text" class="form-control form-custom" name="cea_regular_income_specify"  id="cea_regular_income_specify" value="<?php echo $cea_regular_income_specify; ?>" placeholder="" required readonly>
                    ...
                    <div class="form-group col-md-12">
                        <div class="radio-btn-group">
                            ...
                            <div class="form-check form-check-inline">
                                <input type="radio" name="cea_existing_illness" id="cea_existing_illness_yes" value="1" class="form-check-input" <?php if ($cea_existing_illness == 1) { echo 'checked'; } ?> onclick="return false;" required>
                                <label for="cea_existing_illness_yes">Yes</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input type="radio" name="cea_existing_illness" id="cea_existing_illness_no" value="2" class="form-check-input" <?php if ($cea_existing_illness == 2) { echo 'checked'; } ?> onclick="return false;">
                    ...
                    <div class="form-group col-md-12">
                        <div class="form-group col-md-6">
                            <input type="text" class="form-control form-custom" name="cea_existing_illness_specify" id="cea_existing_illness_specify" value="<?php echo $cea_existing_illness_specify; ?>" placeholder="" readonly>
                    ...
                    <div class="form-group col-md-12">
                        <div class="radio-btn-group">
                            ...
                            <div class="form-check form-check-inline">
                                <input type="radio" name="cea_disability" id="cea_disability_yes" value="1" class="form-check-input" <?php if ($cea_disability == 1) { echo 'checked'; } ?> onclick="return false;" required>
                                <label for="cea_disability_yes">Yes</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input type="radio" name="cea_disability" id="cea_disability_no" value="2" class="form-check-input" <?php if ($cea_disability == 2) { echo 'checked'; } ?> onclick="return false;">
                    ...
                    <div class="form-group col-md-12 mb-5">
                        <div class="form-check form-switch form-check-inline">
                            <input class="form-check-input" type="checkbox" name="cea_disability_deaf" id="cea_disability_deaf" value="1" <?php if ($cea_disability_deaf == 1){ echo 'checked'; }else{ echo 'disabled'; } ?> onclick="return false;">
                            <label class="form-check-label" for="cea_disability_deaf">Deaf/Hard of Hearing</label>
                        </div>
                        <div class="form-check form-switch form-check-inline">
                            <input class="form-check-input" type="checkbox" name="cea_disability_intellectual" id="cea_disability_intellectual" value="1" <?php if ($cea_disability_intellectual == 1){ echo 'checked'; }else{ echo 'disabled'; } ?> onclick="return false;">
                            <label class="form-check-label" for="cea_disability_intellectual">Intellectual</label>
                        </div>
                        <div class="form-check form-switch form-check-inline">
                            <input class="form-check-input" type="checkbox" name="cea_disability_learning" id="cea_disability_learning" value="1" <?php if ($cea_disability_learning == 1){ echo 'checked'; }else{ echo 'disabled'; } ?> onclick="return false;">
                            <label class="form-check-label" for="cea_disability_learning">Learning</label>
                        </div>
                        <div class="form-check form-switch form-check-inline">
                            <input class="form-check-input" type="checkbox" name="cea_disability_mental" id="cea_disability_mental" value="1" <?php if ($cea_disability_mental == 1){ echo 'checked'; }else{ echo 'disabled'; } ?> onclick="return false;">
                            <label class="form-check-label" for="cea_disability_mental">Mental</label>
                        </div>
                        <div class="form-check form-switch form-check-inline">
                            <input class="form-check-input" type="checkbox" name="cea_disability_psychosocial" id="cea_disability_psychosocial" value="1" <?php if ($cea_disability_psychosocial == 1){ echo 'checked'; }else{ echo 'disabled'; } ?> onclick="return false;">
                            <label class="form-check-label" for="cea_disability_psychosocial">Psychosocial</label>
                        </div>
                        <div class="form-check form-switch form-check-inline">
                            <input class="form-check-input" type="checkbox" name="cea_disability_cancer" id="cea_disability_cancer" value="1" <?php if ($cea_disability_cancer == 1){ echo 'checked'; }else{ echo 'disabled'; } ?> onclick="return false;">
                            <label class="form-check-label" for="cea_disability_cancer">Non-apparent cancer</label>
                        </div>
                        <div class="form-check form-switch form-check-inline">
                            <input class="form-check-input" type="checkbox" name="cea_disability_visual" id="cea_disability_visual" value="1" <?php if ($cea_disability_visual == 1){ echo 'checked'; }else{ echo 'disabled'; } ?> onclick="return false;">
                            <label class="form-check-label" for="cea_disability_visual">Non-apparent visual</label>
                        </div>
                        <div class="form-check form-switch form-check-inline">
                            <input class="form-check-input" type="checkbox" name="cea_disability_speech_and_language" id="cea_disability_speech_and_language" value="1" <?php if ($cea_disability_speech_and_language == 1){ echo 'checked'; }else{ echo 'disabled'; } ?> onclick="return false;">
                            <label class="form-check-label" for="cea_disability_speech_and_language">Non-apparent speech and language impairment</label>
                        </div>
                        <div class="form-check form-switch form-check-inline">
                            <input class="form-check-input" type="checkbox" name="cea_disability_rare_disease" id="cea_disability_rare_disease" value="1" <?php if ($cea_disability_rare_disease == 1){ echo 'checked'; }else{ echo 'disabled'; } ?> onclick="return false;">
                    ...
                    <div class="form-group col-md-12">
                        <div class="radio-btn-group">
                            ...
                            <div class="form-check form-check-inline">
                                <input type="radio" name="cea_daily_living" id="cea_daily_living_yes" value="1" class="form-check-input" <?php if ($cea_daily_living == 1) { echo 'checked'; } ?> onclick="return false;" required>
                                <label for="cea_daily_living_yes">Yes</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input type="radio" name="cea_daily_living" id="cea_daily_living_no" value="2" class="form-check-input" <?php if ($cea_daily_living == 2) { echo 'checked'; } ?> onclick="return false;">
                    ...
                    <div class="form-group col-md-12 mb-0">
                        ...
                        <div class="form-check form-switch form-check-inline">
                            <input class="form-check-input" type="checkbox" name="cea_daily_living_bathing" id="cea_daily_living_bathing" value="1" <?php if ($cea_daily_living_bathing == 1){ echo 'checked'; }else{ echo 'disabled'; } ?> onclick="return false;">
                            <label class="form-check-label" for="cea_daily_living_bathing">Bathing</label>
                        </div>
                        <div class="form-check form-switch form-check-inline">
                            <input class="form-check-input" type="checkbox" name="cea_daily_living_dressing" id="cea_daily_living_dressing" value="1" <?php if ($cea_daily_living_dressing == 1){ echo 'checked'; }else{ echo 'disabled'; } ?> onclick="return false;">
                            <label class="form-check-label" for="cea_daily_living_dressing">Dressing</label>
                        </div>
                        <div class="form-check form-switch form-check-inline">
                            <input class="form-check-input" type="checkbox" name="cea_daily_living_grooming" id="cea_daily_living_grooming" value="1" <?php if ($cea_daily_living_grooming == 1){ echo 'checked'; }else{ echo 'disabled'; } ?> onclick="return false;">
                            <label class="form-check-label" for="cea_daily_living_grooming">Grooming</label>
                        </div>
                        <div class="form-check form-switch form-check-inline">
                            <input class="form-check-input" type="checkbox" name="cea_daily_living_eating" id="cea_daily_living_eating" value="1" <?php if ($cea_daily_living_eating == 1){ echo 'checked'; }else{ echo 'disabled'; } ?> onclick="return false;">
                            <label class="form-check-label" for="cea_daily_living_eating">Eating</label>
                        </div>
                        <div class="form-check form-switch form-check-inline">
                            <input class="form-check-input" type="checkbox" name="cea_daily_living_toileting" id="cea_daily_living_toileting" value="1" <?php if ($cea_daily_living_toileting == 1){ echo 'checked'; }else{ echo 'disabled'; } ?> onclick="return false;">
                            <label class="form-check-label" for="cea_daily_living_toileting">Toileting</label>
                        </div>
                        <div class="form-check form-switch form-check-inline">
                            <input class="form-check-input" type="checkbox" name="cea_daily_living_transferring" id="cea_daily_living_transferring" value="1" <?php if ($cea_daily_living_transferring == 1){ echo 'checked'; }else{ echo 'disabled'; } ?> onclick="return false;">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <div class="form-check form-switch form-check-inline">
                            <input class="form-check-input" type="checkbox" name="cea_daily_living_cooking" id="cea_daily_living_cooking" value="1" <?php if ($cea_daily_living_cooking == 1){ echo 'checked'; }else{ echo 'disabled'; } ?> onclick="return false;">
                            <label class="form-check-label" for="cea_daily_living_cooking">Cooking </label>
                        </div>
                        <div class="form-check form-switch form-check-inline">
                            <input class="form-check-input" type="checkbox" name="cea_daily_living_cleaning" id="cea_daily_living_cleaning" value="1" <?php if ($cea_daily_living_cleaning == 1){ echo 'checked'; }else{ echo 'disabled'; } ?> onclick="return false;">
                            <label class="form-check-label" for="cea_daily_living_cleaning">Cleaning </label>
                        </div>
                        <div class="form-check form-switch form-check-inline">
                            <input class="form-check-input" type="checkbox" name="cea_daily_living_managing_finance" id="cea_daily_living_managing_finance" value="1" <?php if ($cea_daily_living_managing_finance == 1){ echo 'checked'; }else{ echo 'disabled'; } ?> onclick="return false;">
                            <label class="form-check-label" for="cea_daily_living_managing_finance">Managing Finances</label>
                        </div>
                        <div class="form-check form-switch form-check-inline">
                            <input class="form-check-input" type="checkbox" name="cea_daily_living_grocery_shopping" id="cea_daily_living_grocery_shopping" value="1" <?php if ($cea_daily_living_grocery_shopping == 1){ echo 'checked'; }else{ echo 'disabled'; } ?> onclick="return false;">
                            <label class="form-check-label" for="cea_daily_living_grocery_shopping">Grocery shopping</label>
                        </div>
                        <div class="form-check form-switch form-check-inline">
                            <input class="form-check-input" type="checkbox" name="cea_daily_living_managing_medications" id="cea_daily_living_managing_medications" value="1" <?php if ($cea_daily_living_managing_medications == 1){ echo 'checked'; }else{ echo 'disabled'; } ?> onclick="return false;">
            ...
            <div id="Recommendation" class="tabcontent">
                <div class="mb-5 mt-2">
                    <a href="<?php echo base_url().'validator/client/list'; ?>" class="btn btn-back hvr-float-shadow"><i class="fa-solid fa-caret-left"></i> Back</a>
                    <button class="btn btn-edit recom-edit hvr-float-shadow" id="edit" style="display:none;"><i class="fa-solid fa-pen-to-square fa-sm"></i> Edit</button>
                    <button class="btn btn-edit-cancel recom-edit-cancel hvr-float-shadow" style="display:none;"><i class="fa-solid fa-xmark fa-sm"></i> Cancel Edit</button>
                </div>
                <form method="POST" action="<?php echo base_url().'validator/client/update_recommendation'; ?>" id="recommendation_form" autocomplete="off">
                    <div class="row">
                        <div class="col-md-12">
                            <input type="hidden" name="old_client_status" value="<?php echo $client_status; ?>" readonly>
                            <div class="form-group col-md-2">
                                <select name="client_status" id="client_status" class="form-select <?php echo (isset($client_status) && $client_status == $client_status) ? 'has-value' : ''; ?> recommendation_edit" required disabled>
                                    <option value="1" <?php if($client_status == 1){ echo "selected";} ?>>Active</option>
                                    <option value="2" <?php if($client_status == 2){ echo "selected";} ?>>Waitlisted</option>
                                    <option value="3" <?php if($client_status == 3){ echo "selected";} ?>>Delisted</option>
                                    <option value="4" <?php if($client_status == 4){ echo "selected";} ?>>Not Eligible</option>
                                </select>
                                <label for="client_status" class="form-label fw-bold">STATUS <span class="text-danger">*</span></label>
                            </div>
                        </div>
                        <div class="col-md-7">
                        <div class="form-group">
                                <div class="radio-btn-group">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="eligible" id="eligible_yes" value="1" <?php if ($eligible == 1) { echo 'checked'; } ?> onclick="return false;">
                                        <label class="form-check-label" for="eligible_yes">Eligible</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="eligible" id="cr_not_eligible" value="2" <?php if ($eligible == 2) { echo 'checked'; } ?> onclick="return false;">
                            ...
                            <div class="form-group">
                                <textarea class="form-control form-custom textarea-custom recommendation_edit" name="cr_remarks" placeholder="" rows="20" readonly><?php echo $cr_remarks; ?></textarea>
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                <input type="text" class="form-control form-custom" name="cr_validated_by" value="<?php echo $user_fname.' '.$user_mname.' '.$user_lname.' '.$user_ename; ?>" placeholder="" required readonly>
                                <label class="form-label fw-bold">VALIDATED BY <span class="text-danger">*</span></label>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control form-custom" name="cr_validated_designation" value="<?php echo $user_designation; ?>" placeholder="" required readonly>
                                <label class="form-label fw-bold">DESIGNATION <span class="text-danger">*</span></label>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control form-custom date-picker" name="cr_validated_date" value="<?php echo $cr_validated_date; ?>" placeholder="" required>
                                <label class="form-label fw-bold">DATE <span style="font-size: 12px" >(yyyy-mm-dd)</span> <span class="text-danger">*</span></label>
                            </div>

                            <div class="form-group" style="margin-top: 50px">
                                <input type="text" class="form-control form-custom" name="cr_conformed_by" value="<?php echo $conformed_fname.' '.$conformed_mname.' '.$conformed_lname.' '.$conformed_ename; ?>" placeholder="" required readonly>
                                <label class="form-label fw-bold">CONFORMED BY <span class="text-danger">*</span></label>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control form-custom" name="cr_conformed_designation" value="<?php echo $conformed_designation; ?>" placeholder="" required readonly>
                                <label class="form-label fw-bold">DESIGNATION <span class="text-danger">*</span></label>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control form-custom date-picker" name="cr_conformed_date" value="<?php echo $cr_conformed_date; ?>" placeholder="" required>
                                <label class="form-label fw-bold">DATE <span style="font-size: 12px" >(yyyy-mm-dd)</span> <span class="text-danger">*</span></label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-center my-4">
                        <input type="hidden" class="form-control form-custom recommendation_edit" name="client_id" value="<?php echo $client_id; ?>" placeholder="" readonly>
                        <button type="submit" class="btn btn-custom recom-save hvr-float-shadow" style="display:none; width: 300px" onclick="return confirm('Are you sure you want to save?')"><i class="fa-solid fa-floppy-disk"></i> Save</button>
                        <button type="submit" class="btn btn-custom recom-save hvr-float-shadow" style="display:none; width: 300px" onclick="return confirm('Are you sure you want to save?')"><i class="fa-solid fa-floppy-disk"></i> Save</button>
                    </div>
            </form>
            ...
            <script>
                 var validationId = "<?php echo $validation_id; ?>";
    var userId = "<?php echo $user_id; ?>";


                // Check if validationId matches userId, then show or hide the edit button
                if (validationId === userId) {
                    document.getElementById('edit').style.display = 'inline-block';
                }

                function toggleEditMode(editing) {
                    document.querySelectorAll('.recommendation_edit').forEach(function(element) {
                        if (element.tagName === 'TEXTAREA') {
                            element.readOnly = !editing;
                        } else if (element.tagName === 'SELECT' || element.type === 'checkbox' || element.type === 'radio') {
                            element.disabled = !editing;
                        }
                    });

                    document.querySelector('.recom-edit').style.display = editing ? 'none' : 'inline-block';
                    document.querySelector('.recom-edit-cancel').style.display = editing ? 'inline-block' : 'none';
                    document.querySelector('.recom-save').style.display = editing ? 'inline-block' : 'none';

                    if (editing) {
                        $('#bday').datepicker("enable"); 
                    } else {
                        $('#bday').datepicker("disable"); 
                    }
                }

                document.querySelector('.recom-edit').addEventListener('click', function() {
                    toggleEditMode(true);
                });

                document.querySelector('.recom-edit-cancel').addEventListener('click', function() {
                    toggleEditMode(false);
                });

                document.getElementById('recommendation_form').addEventListener('submit', function(event) {
                    var inputs = document.querySelectorAll('.recommendation_edit');
                    var valid = true;
