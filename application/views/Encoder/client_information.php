    ...
    <div class="card card-shadow my-4" style="width: 75rem;">
        ...
        <div class="card-body">
            ...
            <div id="IndentifyingInformation" class="tabcontent">
                <div class="mb-3 mt-2">
                    <a href="<?php echo base_url().'encoder/client/list'; ?>" class="btn btn-back hvr-float-shadow"><i class="fa-solid fa-caret-left"></i> Back</a>
                ...
                <form method="POST" action="<?php echo base_url().'encoder/client/update_client_identifying_information'; ?>" id="identifying_information_form" autocomplete="off">
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="d-flex justify-content-center my-4">
                            <input type="hidden" class="form-control form-custom identifying_information_edit" name="client_id" value="<?php echo $client_id; ?>" placeholder="" readonly>
                ...
                <script>
                    ...
                    function toggleEditButton() {
                        var editButton = document.querySelector('.ii-edit');
                        if (validationId !== 0) {
                    ...
                    function toggleIdentifyingInformationEditMode(editing) {
                        ...
                        document.querySelector('.ii-edit').style.display = editing ? 'none' : 'inline-block';
                        document.querySelector('.ii-edit-cancel').style.display = editing ? 'inline-block' : 'none';
                        document.querySelector('.ii-save').style.display = editing ? 'inline-block' : 'none';
                    ...
                    document.querySelector('.ii-edit').addEventListener('click', function() {
                        toggleIdentifyingInformationEditMode(true);
                    });

                    document.querySelector('.ii-edit-cancel').addEventListener('click', function() {
                        toggleIdentifyingInformationEditMode(false);
                    });

                    document.getElementById('identifying_information_form').addEventListener('submit', function(event) {
                        var inputs = document.querySelectorAll('.identifying_information_edit');
                        var valid = true;
            ...
            <div id="FamilyInformation" class="tabcontent">
                <div class="mb-3 mt-2">
                    <a href="<?php echo base_url().'encoder/client/list'; ?>" class="btn btn-back hvr-float-shadow"><i class="fa-solid fa-caret-left"></i> Back</a>
                    <button class="btn btn-edit fi-edit hvr-float-shadow" id="edit"><i class="fa-solid fa-pen-to-square fa-sm"></i> Edit</button>
                    <button class="btn btn-edit-cancel fi-edit-cancel hvr-float-shadow" style="display:none;"><i class="fa-solid fa-xmark fa-sm"></i> Cancel Edit</button>
                </div>

                <form method="POST" action="<?php echo base_url().'encoder/client/update_hm_family_information'; ?>" id="family_information_form" autocomplete="off">
                    ...
                    <div class="d-flex justify-content-center my-4">
                        <input type="hidden" name="client_id" class="form-control form-custom" value="<?php echo $client_id; ?>" required>
                        <button type="submit" class="btn btn-custom fi-save hvr-float-shadow" style="display:none; width: 300px" onclick="return confirm('Are you sure you want to save?')"><i class="fa-solid fa-floppy-disk"></i> Save</button>
                    </div>
                </form>
                ...
                <script>
                    ...
                    $(document).ready(function () {
                        ...
                        function toggleEditMode(editing) {
                            document.querySelectorAll('.chm-remove-row').forEach(function(button) {
                                button.style.display = editing ? 'inline-block' : 'none';
                            });

                            document.getElementById('chm-add-row').style.display = editing ? 'inline-block' : 'none';
                        }
                        ...
                        document.querySelector('.fi-edit').addEventListener('click', function() {
                            toggleEditMode(true); 
                        });

                        document.querySelector('.fi-edit-cancel').addEventListener('click', function() {
                    ...
                    $(document).ready(function () {
                        ...
                        function toggleEditMode(editing) {
                            document.querySelectorAll('.car-remove-row').forEach(function(button) {
                                button.style.display = editing ? 'inline-block' : 'none';
                            });

                            document.getElementById('car-add-row').style.display = editing ? 'inline-block' : 'none';
                        }
                ...
                <script>
                    ...
                    function toggleEditButton() {
                        var editButton = document.querySelector('.fi-edit');
                        if (validationId !== 0) {
                            editButton.style.display = 'none';
                        } else {
                            editButton.style.display = 'inline-block';
                    ...
                    function toggleFamilyInformationEditMode(editing) {
                        document.querySelectorAll('.family_information_edit').forEach(function(element) {
                            if (element.tagName === 'INPUT' && element.type !== 'checkbox' && element.type !== 'radio') {
                                element.readOnly = !editing;
                            } else if (element.tagName === 'SELECT' || element.type === 'checkbox' || element.type === 'radio') {
                                element.disabled = !editing;
                        ...
                        document.querySelector('.fi-edit').style.display = editing ? 'none' : 'inline-block';
                        document.querySelector('.fi-edit-cancel').style.display = editing ? 'inline-block' : 'none';
                        document.querySelector('.fi-save').style.display = editing ? 'inline-block' : 'none';

                        if (editing) {
                            document.querySelector('.chm-remove-row').style.display = 'inline-block';
                            document.querySelector('#chm-add-row').style.display = 'inline-block';
                        } else {
                            document.querySelector('.chm-remove-row').style.display = 'none';
                            document.querySelector('#chm-add-row').style.display = 'none';
                        }
                    }

                    document.querySelector('.fi-edit').addEventListener('click', function() {
                        toggleFamilyInformationEditMode(true);
                    });

                    document.querySelector('.fi-edit-cancel').addEventListener('click', function() {
                        toggleFamilyInformationEditMode(false);
                    });

                    document.getElementById('family_information_form').addEventListener('submit', function(event) {
                        var inputs = document.querySelectorAll('.family_information_edit');
                        var valid = true;
            ...
            <div id="Remarks" class="tabcontent">
                <div class="mb-3 mt-2">
                    <a href="<?php echo base_url().'encoder/client/list'; ?>" class="btn btn-back hvr-float-shadow"><i class="fa-solid fa-caret-left"></i> Back</a>
                    <button class="btn btn-edit remarks-edit hvr-float-shadow" id="edit"><i class="fa-solid fa-pen-to-square fa-sm"></i> Edit</button>
                    <button class="btn btn-edit-cancel remarks-edit-cancel hvr-float-shadow" style="display:none;"><i class="fa-solid fa-xmark fa-sm"></i> Cancel Edit</button>
                </div>
                <form method="POST" action="<?php echo base_url().'encoder/client/update_client_identifying_information_remarks'; ?>" id="family_information_form" autocomplete="off">
                    <div class="row mt-4">
                        <div class="col">
                    ...
                    <div class="d-flex justify-content-center my-4">
                        <input type="hidden" name="client_id" class="form-control form-custom" value="<?php echo $client_id; ?>" required>
                        <button type="submit" class="btn btn-custom remarks-save hvr-float-shadow" style="display:none; width: 300px" onclick="return confirm('Are you sure you want to save?')"><i class="fa-solid fa-floppy-disk"></i> Save</button>
                    </div>
                </form>
            </div>
            ...
            <script>
                ...
                function toggleEditButton() {
                    var editButton = document.querySelector('.remarks-edit');
                    if (validationId !== 0) {
                        editButton.style.display = 'none';
                    } else {
                        editButton.style.display = 'inline-block';
                ...
                function toggleRemarksEditMode(editing) {
                    document.querySelectorAll('.remarks_edit').forEach(function(element) {
                        if (element.tagName === 'TEXTAREA') {
                            element.readOnly = !editing;
                        }
                    });

                    document.querySelector('.remarks-edit').style.display = editing ? 'none' : 'inline-block';
                    document.querySelector('.remarks-edit-cancel').style.display = editing ? 'inline-block' : 'none';
                    document.querySelector('.remarks-save').style.display = editing ? 'inline-block' : 'none';
                ...
                document.querySelector('.remarks-edit').addEventListener('click', function() {
                    toggleRemarksEditMode(true);
                });

                document.querySelector('.remarks-edit-cancel').addEventListener('click', function() {
                    toggleRemarksEditMode(false);
                });

                document.getElementById('family_information_form').addEventListener('submit', function(event) {
                    var inputs = document.querySelectorAll('.remarks_edit');
                    var valid = true;
