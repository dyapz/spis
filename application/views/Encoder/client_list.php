...
<script>
    ...
    var table = $('#spis_table').DataTable({
        ...
        ajax: {
            url: "<?php echo base_url('encoder/client/client_data_list'); ?>",
            type: 'POST',
            data: function(d) {
                d[csrfName] = csrfHash; 
...
<script>
    ...
    fetch('<?php echo base_url('encoder/client/check_client'); ?>', {
        method: 'POST',
        body: formData
    })
    ...
    .then(data => {
        ...
        document.getElementById('confirmYes').onclick = function() {
            window.location.href = '<?php echo base_url('encoder/client/new'); ?>';
        };
