<?php 
   ...
   if($message == 'GSIS Match found. Do you want to continue?'){
        $duplicate = '1';

    }else if($message == 'PVAO Match found. Do you want to continue?'){
        $duplicate = '2';

    }else if($message == 'Duplicate found. Do you want to continue?'){
        $duplicate = '3';
  ...
  <div class="row d-flex justify-content-center">
    <div class="col-12 col-lg-8 ml-auto mr-auto mb-2">
      <div class="multisteps-form_progress">
        ...
        <button class="multisteps-form_progress-btn" type="button" title="Family Information">Family Information</button>
        <button class="multisteps-form_progress-btn" type="button" title="Remarks">Remarks</button>
      </div>
    </div>
  </div>
  <div class="row">
    <div class="col-12 col-lg-8 m-auto">
        ...
        <form class="multisteps-form_form" action="<?php echo base_url().'encoder/client/save_client'?>" method="POST">
        <!-- IDENTIFYING INFORMATION -->
        <div class="multisteps-form_panel card-shadow p-4 rounded bg-white js-active" data-animation="scaleIn">
                 <div class="form-group col-md-4">
                    <input type="text" class="form-control form-custom date-picker" name="date_submitted" value="<?php echo set_value('date_submitted', isset($client_data['date_submitted']) ? $client_data['date_submitted'] : ''); ?>" placeholder="" required>
                    <label class="form-label fw-bold">DATE SUBMITTED <span style="font-size: 12px" >(yyyy-mm-dd)</span> <span class="text-danger">*</span></label>
                    </div>
            <h5 class="multisteps-form_title">IDENTIFYING INFORMATION</h5>
            <div class="multisteps-form_content mt-4">
                <div class="row">
                <label class="label mb-3 fw-bold">NAME:</label><br>
                <div class="form-group col-md-3">
                    <input type="text" id="client_lname" class="form-control form-custom" name="client_lname" value="<?php echo set_value('client_lname', isset($client_data['client_lname']) ? $client_data['client_lname'] : '');?>" placeholder="" required>
                    <label class="form-label fw-bold">LAST NAME <span class="text-danger">*</span></label>
                </div>

                <div class="form-group col-md-3">
                    <input type="text" id="client_fname" class="form-control form-custom" name="client_fname" value="<?php echo set_value('client_fname', isset($client_data['client_fname']) ? $client_data['client_fname'] : '');?>" placeholder="" required>
                    <label class="form-label fw-bold">FIRST NAME <span class="text-danger">*</span></label>
                </div>

                <div class="form-group col-md-3">
                    <input type="text" id="client_mname" class="form-control form-custom" name="client_mname" value="" placeholder="">
                    <label class="form-label fw-bold">MIDDLE NAME</label>
                </div>

                <div class="form-group col-md-3">
                    <input type="text" id="client_ename" class="form-control form-custom" name="client_ename" value="" placeholder="">
                    <label class="form-label fw-bold">EXT. NAME</label>
                </div>

                <div class="form-group col-md-4">
                    <input type="text" id="osca_id" class="form-control form-custom" name="osca_id" value="" placeholder="" required>
                    <label class="form-label fw-bold">OSCA ID No. <span class="text-danger">*</span></label>
                </div>

                    <div class="form-group col-md-4">
                        <input type="text" id="philsys_id" class="form-control form-custom" name="philsys_id" value="" placeholder="">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <div class="radio-btn-group">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="pantawid_y_n" id="4psyes" value="1" required="required">
                                <label class="form-check-label" for="4psyes">Yes</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="pantawid_y_n" id="4psno" value="2">
                    ...
                    <div class="form-group col-md-4">
                        <input type="text" id="mothers_maiden_lname" class="form-control form-custom" name="mothers_maiden_lname" value="" placeholder="" required>
                        <label class="form-label fw-bold">LAST NAME <span class="text-danger">*</span></label>
                    </div>

                    <div class="form-group col-md-4">
                        <input type="text" id="mothers_maiden_fname" class="form-control form-custom" name="mothers_maiden_fname" value="" placeholder="" required>
                        <label class="form-label fw-bold">FIRST NAME <span class="text-danger">*</span></label>
                    </div>

                    <div class="form-group col-md-4">
                        <input type="text" name="mothers_maiden_mname" class="form-control form-custom" name="mothers_maiden_mname" value="" placeholder="">
                        <label class="form-label fw-bold">MIDDLE NAME</label>
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        <input type="text" class="form-control form-custom" name="perm_sitio" id="perm_sitio" value="" placeholder="" required>
                        <label class="form-label fw-bold">HOUSE NO./ PUROK <span class="text-danger">*</span></label>
                    </div>
                    
                    <div class="form-group col-md-4">
                        <input type="text" class="form-control form-custom" name="perm_street" id="perm_street" value="" placeholder="" required>
                        <label class="form-label fw-bold">STREET <span class="text-danger">*</span></label>
                    </div>
                </div>

                <div class="form-check mb-2">
                    <input class="form-check-input" type="checkbox" value="1" id="copyResult" name="same_address">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        <input type="text" class="form-control form-custom" name="pre_sitio" id="pre_sitio" value="" placeholder="" required>
                        <label class="form-label fw-bold">HOUSE NO./ PUROK <span class="text-danger">*</span></label>
                    </div>

                        <div class="form-group col-md-4">
                            <input type="text" class="form-control form-custom" name="pre_street" id="pre_street" value="" placeholder="" required>
                            <label class="form-label fw-bold">STREET <span class="text-danger">*</span></label>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-2">
                        <input type="text" class="form-control form-custom" name="birth_place" value="" placeholder="" required>
                    ...
                    <div class="form-group col-md-2" id="cs_others_group" style="display: none;">
                        <input type="text" id="cs_others" class="form-control form-custom" name="cs_others" value="" placeholder="">
                    ...
                    <div class="form-group col-md-3 d-flex justify-content-start">
                        <select id="living_arrangement" name="living_arrangement" class="form-select <?php echo (isset($client_data['living_arrangement']) && $client_data['living_arrangement'] == $client_data['living_arrangement']) ? 'has-value' : ''; ?>" required>
                            ...
                            <option value="2">2 - LIVING WITH SPOUSE</option>
                            <option value="3">3 - LIVING WITH CHILDREN</option>
                    ...
                    <div class="form-group col-md-3" id="living_arrangement_others_group" style="display: none;">
                        <input type="text" id="living_arrangement_others" class="form-control form-custom" name="living_arrangement_others" value="" placeholder="">
                        <label class="form-label fw-bold">SPECIFY <span class="text-danger">*</span></label>
                    </div>
                    ...
                    <div class="form-group col-md-3">
                        <select id="sector" class="form-select <?php echo (isset($client_data['sector']) && $client_data['sector'] == $client_data['sector']) ? 'has-value' : ''; ?>" name="sector">
                            <option value="" disabled selected></option>
                            <option value="1">1 - INDIGENOUS PEOPLE (Mga Katutubo)</option>
                            <option value="2">2 - PERSON WITH DISABILITY</option>
                            <option value="3">3 - SOLO PARENT</option>
                            <option value="4">4 - MEMBER OF LGBTTQIA+++</option>
                        </select>
                    ...
                    <div id="ip_specify_group" style="display: none;">
                            <input type="text" id="ip_specify" class="form-control form-custom" name="ip_specify" value="" placeholder="">
                            <label class="form-label fw-bold">SPECIFY <span class="text-danger">*</span></label>
                        </div>
                    </div>
        ...
        <div class="multisteps-form_panel card-shadow p-4 rounded bg-white" data-animation="scaleIn">
            <h5 class="multisteps-form_title">FAMILY INFORMATION</h5>
            <div class="multisteps-form_content">
                <div id="cs_married_group" style="display: none;">
                    <div class="row">
                        ...
                        <div class="form-group col-md-3">
                            <input type="text" id="cs_lname" class="form-control form-custom" name="cs_lname" value="" placeholder="">
                            <label class="form-label fw-bold">LAST NAME <span class="text-danger">*</span></label>
                        </div>

                        <div class="form-group col-md-3">
                            <input type="text" id="cs_fname" class="form-control form-custom" name="cs_fname" value="" placeholder="">
                            <label class="form-label fw-bold">FIRST NAME <span class="text-danger">*</span></label>
                        </div>

                        <div class="form-group col-md-3">
                            <input type="text" class="form-control form-custom" name="cs_mname" value="" placeholder="">
                            <label class="form-label fw-bold">MIDDLE NAME</label>
                        </div>

                        <div class="form-group col-md-3">
                            <input type="text" class="form-control form-custom" name="cs_ename" value="" placeholder="">
                            <label class="form-label fw-bold">EXT. NAME</label>
                        </div>

                        <div class="form-group col-md-9">
                            <input type="text" id="cs_address" class="form-control form-custom" name="cs_address" value="" placeholder="">
                            <label class="form-label fw-bold">ADDRESS <span class="text-danger">*</span></label>
                        </div>

                        <div class="form-group col-md-3">
                            <input type="text" class="form-control form-custom" name="cs_contact_num" value="" placeholder="">
                ...
                <table id="fam_info_details" class="table table-bordered spis_table" style="width:100%; margin-top: 0px">
                    ...
                    <tr class="align-text-bottom">
                        <td><input type="text" name="fam_info[0][chm_name]" class="form-control form-custom" value="" required></td>
                        <td><input type="text" name="fam_info[0][chm_age]" class="form-control form-custom" value="" required></td>
                        <td>
                            <select class="form-select chm-civil-status-select" name="fam_info[0][chm_civil_status]" required>
                                <option value="" disabled selected></option>
                                <option value="1">1 - SINGLE</option>
                                <option value="2">2 - MARRIED</option>
                                <option value="3">3 - SEPARATED</option>
                            ...
                            <div class="chm-civil-status-others-group" style="display: none;">
                                <input type="text" class="form-control form-custom chm-civil-status-others" name="fam_info[0][chm_civil_status_others]" value="" placeholder="SPECIFY">
                            </div>
                        </td>
                        <td>
                            <select class="form-select chm-relationship-select" name="fam_info[0][chm_relationship]" required>
                                <option value="" disabled selected></option>
                            ...
                            <div class="chm-relationship-others-group" style="display: none;">
                                <input type="text" class="form-control form-custom chm-relationship-others" name="fam_info[0][chm_relationship_others]" value="" placeholder="SPECIFY">
                            </div>
                        </td>
                        <td><input type="text" name="fam_info[0][chm_occupation]" class="form-control form-custom" value="" required></td>
                        <td><input type="text" name="fam_info[0][chm_monthly_income]" class="form-control form-custom" value="" required></td>
                        <td></td>
                    </tr>
                </table>
                ...
                <table id="auth_rep_details" class="table table-bordered spis_table" style="width:100%; margin-top: 0px">
                    ...
                    <tr class="align-text-bottom">
                        <td><input type="text" name="fam_info[0][car_name]" class="form-control form-custom" value="" required></td>
                        <td><input type="text" name="fam_info[0][car_age]" class="form-control form-custom" value="" required></td>
                        <td>
                            <select class="form-select car-relationship-select" name="fam_info[0][car_relationship]" required>
                                <option value="" disabled selected></option>
                                <option value="1">1 - SPOUSE</option>
                                <option value="2">2 - CHILD</option>
                                <option value="3">3 - SIBLING</option>
                            ...
                            <div class="car-relationship-others-group" style="display: none;">
                                <input type="text" class="form-control form-custom car-relationship-others" name="fam_info[0][car_relationship_others]" value="" placeholder="SPECIFY">
                            </div>
                        </td>
                        <td><input type="text" name="fam_info[0][car_contact]" class="form-control form-custom" value="" required></td>
                        <td></td>
                    </tr>
                </table>
            ...
            <script>
                ...
                $(document).ready(function () {
                    ...
                    $("#chm-add-row").click(function () {
                        var newRow = '<tr>' +
                            '<td><input type="text" name="fam_info[' + rowIndex + '][chm_name]" class="form-control form-custom" value="" required></td>' +
                            '<td><input type="text" name="fam_info[' + rowIndex + '][chm_age]" class="form-control form-custom" value="" required></td>' +
                            '<td>' +
                                '<select class="form-select chm-civil-status-select" name="fam_info[' + rowIndex + '][chm_civil_status]" required>' +
                                    '<option value="" disabled selected></option>' +
                                    '<option value="1">1 - SINGLE</option>' +
                                    '<option value="2">2 - MARRIED</option>' +
                                    '<option value="3">3 - SEPARATED</option>' +
                                ...
                                '</select>' +
                                '<div class="chm-civil-status-others-group" style="display: none;">' +
                                    '<input type="text" class="form-control form-custom chm-civil-status-others" name="fam_info[' + rowIndex + '][chm_civil_status_others]" value="" placeholder="SPECIFY">' +
                                '</div>' +
                            '</td>' +
                            '<td>' +
                                '<select class="form-select chm-relationship-select" name="fam_info[' + rowIndex + '][chm_relationship]" required>' +
                                    '<option value="" disabled selected></option>' +
                                    '<option value="1">1 - SPOUSE</option>' +
                                    '<option value="2">2 - CHILD</option>' +
                                    '<option value="3">3 - SIBLING</option>' +
                                ...
                                '</select>' +
                                '<div class="chm-relationship-others-group" style="display: none;">' +
                                    '<input type="text" class="form-control form-custom chm-relationship-others" name="fam_info[' + rowIndex + '][chm_relationship_others]" value="" placeholder="SPECIFY">' +
                                '</div>' +
                            '</td>' +
                            '<td><input type="text" name="fam_info[' + rowIndex + '][chm_occupation]" class="form-control form-custom" value="" required></td>' +
                            '<td><input type="text" name="fam_info[' + rowIndex + '][chm_monthly_income]" class="form-control form-custom" value="" required></td>' +
                            '<td><button type="button" class="remove-row btn btn-danger btn-sm">-</button></td>' +
                        '</tr>';

                        $("#fam_info_details").append(newRow);
                        setupRow(rowIndex); 
                ...
                $(document).ready(function () {
                    ...
                    $("#car-add-row").click(function () {
                        var newRow = '<tr>' +
                            ...
                            '<td>' +
                                '<select class="form-select car-relationship-select" name="fam_info[' + rowIndex + '][car_relationship]" required>' +
                                    '<option value="" disabled selected></option>' +
                                    '<option value="1">1 - SPOUSE</option>' +
                                    '<option value="2">2 - CHILD</option>' +
                                    '<option value="3">3 - SIBLING</option>' +
        ...
        <!--REMARKS-->
        <div class="multisteps-form_panel card-shadow p-4 rounded bg-white" data-animation="scaleIn">
          <h5 class="multisteps-form_title mb-4">REMARKS</h5>
          <div class="multisteps-form_content">
            ...
            <div class="row">
                <div class="col">
                    <div class="form-group">
                        <textarea class="form-control form-custom textarea-custom" name="remarks" placeholder="" rows="10"><?php echo set_value('remarks', isset($client_data['remarks']) ? $client_data['remarks'] : ''); ?></textarea>
...
<script>
    ...
    const areFieldsValid = () => {
        const clientLname = document.getElementById('client_lname');
        const clientFname = document.getElementById('client_fname');
        const clientMname = document.getElementById('client_mname');
        const clientEname = document.getElementById('client_ename');
        const oscaId = document.getElementById('osca_id');
        const philsysId = document.getElementById('philsys_id');
        const csLname = document.getElementById('cs_lname');
        
        const namePattern = /^[A-Za-z\s]+$/;
        const numberOnly = /^[0-9]+$/; 
        const textNumberOnly = /^[A-Za-z0-9\s]+$/; 

        if (!namePattern.test(clientLname.value)) {
            alert('Invalid input in "Last Name". Only letters and spaces are allowed.');
            return false;
        }

        if (!namePattern.test(clientFname.value)) {
            alert('Invalid input in "First Name". Only letters and spaces are allowed.');
            return false;
        }

        if (clientMname.value && !namePattern.test(clientMname.value)) { 
            alert('Invalid input in "Middle Name". Only letters and spaces are allowed.');
            return false;
        }

        if (clientEname.value && !namePattern.test(clientEname.value)) { 
            alert('Invalid input in "Ext. Name". Only letters and spaces are allowed.');
            return false;
        }

        if (!textNumberOnly.test(oscaId.value)) {
            alert('Invalid input in "OSCA ID No.". Only numbers are allowed.');
            return false;
        }

        if (philsysId.value && !textNumberOnly.test(philsysId.value)) {
            alert('Invalid input in "PhilSys. ID No.". Only letters and numbers are allowed.');
            return false;
        }
